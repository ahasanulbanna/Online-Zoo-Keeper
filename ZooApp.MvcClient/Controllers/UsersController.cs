...
namespace ZooApp.MvcClient.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Login([Bind(Include = "Id,Name,Email,Password")] User user)
        {
            var users = db.Users.SingleOrDefault(ux => ux.Email == user.Email && ux.Password == user.Password);
            if (users != null)
            {
                return RedirectToAction("Index", "AnimalFoods");
            }
            return View();
        }
